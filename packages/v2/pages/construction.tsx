    ...
    <BaseLayout>
      ...
      <div className="bg-indigo-700 text-white">
        <div className="container-wide py-16">
          ...
          <p className="mt-4 text-lg text-indigo-200 max-w-3xl">
            Thanks for your patience as I continue to build and improve this
            portfolio site.
          </p>
        </div>
      </div>
        ...
        <div className="container-narrow">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-xl mx-auto">
              I'm actively working on this portfolio website to showcase my data
              analysis projects. While you're welcome to browse the available
              content, please note that some sections are still being developed.
            </p>
          </div>
                  ...
                  <div className="overflow-hidden h-2 text-xs flex rounded bg-gray-200">
                    <div
                      ...
                      className={`${
                        ...
                        : section.progress > 50 ? 'bg-indigo-500'
                        : 'bg-amber-500'
                      } h-full`}
                    ></div>
                  </div>
          ...
          <div>
            ...
            <div className="relative pl-10 space-y-8 before:absolute before:left-5 before:top-2 before:h-full before:border-l-2 before:border-indigo-200">
              ...
              <div className="relative">
                ...
                <p className="text-gray-600 mb-1">
                  About page and skills showcase
                </p>
                <p className="text-sm text-gray-500">Completed</p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="text-gray-600 mb-1">
                  Adding project content and case studies
                </p>
      ...
      <section className="py-10 bg-indigo-700 text-white">
        <div className="container-narrow text-center">
          <h2 className="text-2xl text-indigo-100 font-bold mb-4">
