          ...
          <div className="md:flex md:items-center md:justify-between">
            <div className="md:w-1/2">
              ...
              <div className="mt-8 flex flex-col sm:flex-row sm:space-x-4">
                <a
                  href="#projects"
                  className="bg-white text-indigo-700 font-medium py-3 px-6 rounded-lg shadow-md hover:bg-indigo-50"
                >
                  View My Work
                </a>
                <a
                  href="#contact"
                  className="mt-4 sm:mt-0 bg-transparent border border-white text-white font-medium py-3 px-6 rounded-lg hover:bg-indigo-600"
                >
                  Contact Me
                </a>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 text-center">
                Advanced formulas, pivot tables, data modeling, and automation
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 text-center">
                Data analysis, cleaning, and visualization with pandas, numpy,
                matplotlib
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 text-center">
                Database design, complex queries, optimization, and data
                extraction
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              ...
              <p className="text-gray-600 text-center">
                Interactive dashboards and reports with Power BI and Tableau
              </p>
            </div>
          </div>
        </div>
      ...
      <div id="projects" className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Created a dynamic Excel dashboard analyzing regional sales
                  performance with YoY comparisons
                </p>
                <a
                  href="#"
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Applied clustering algorithms to identify key customer
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Developed an interactive dashboard for tracking company-wide
          ...
          <div className="mt-10 text-center">
            <a
              href="#"
              className="inline-block bg-indigo-600 text-white font-medium py-3 px-6 rounded-lg shadow-md hover:bg-indigo-700"
            >
              View All Projects
            </a>
          </div>
      ...
      <div id="contact" className="bg-indigo-700 text-white py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            ...
            className="inline-block bg-white text-indigo-700 font-medium py-3 px-8 rounded-lg shadow-md hover:bg-indigo-50"
          >
            Get in Touch
          </a>
        </div>
