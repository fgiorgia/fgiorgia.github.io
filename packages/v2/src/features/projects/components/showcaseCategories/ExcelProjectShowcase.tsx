        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
              <li>
                Advanced formulas and functions (XLOOKUP, INDEX/MATCH, SUMIFS)
              </li>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-2">
              ...
              <li>
                Modular design with dedicated data, calculation, and display
                sheets
              </li>
        ...
        <div className="mt-8">
          ...
          >
            <p className="text-gray-700">
              This project leveraged advanced Excel techniques to transform raw
              data into actionable insights. The dashboard integrates data from
              multiple sources and provides real-time analysis through dynamic
              charts, slicers, and conditional formatting.
            </p>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className={`${colorScheme.bg} p-4 rounded-md`}>
            <h3
              className={`text-lg font-semibold ${colorScheme.secondary} mb-3`}
            >
        ...
        <div className="mt-6">
          ...
          >
            <p className="text-gray-500 italic">
              Excel dashboard visualization would be displayed here
            </p>
...
export default ExcelProjectShowcase;
