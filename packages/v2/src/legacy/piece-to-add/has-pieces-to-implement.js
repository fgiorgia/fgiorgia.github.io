    ...
    excel: [
      {
        ...
        description:
          'Interactive dashboard tracking KPIs across regions with dynamic filtering and forecasting.',
      ...
      },
      {
        ...
        description:
          'Automated spreadsheet solution comparing actual vs. budgeted expenses with variance calculations.',
    ...
    python: [
      {
        ...
        description:
          'K-means clustering algorithm to identify customer segments based on purchasing behavior.',
      ...
      },
      {
        ...
        description:
          'ARIMA and Prophet models to forecast product demand with 92% accuracy.',
    ...
    sql: [
      {
        ...
        description:
          'Database schema design and query optimization reducing report generation time by 65%.',
      ...
      },
      {
        ...
        description:
          'Complex SQL queries analyzing customer response rates across marketing channels.',
    ...
    bi: [
      {
        ...
        description:
          'Interactive Power BI dashboard providing real-time sales performance visualization.',
      ...
      },
      {
        ...
        description:
          'End-to-end supply chain visualization identifying bottlenecks and optimization opportunities.',
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <a href="#" className="text-xl font-bold text-indigo-600">
                DataAnalyst<span className="text-gray-800">Portfolio</span>
              </a>
            </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white p-4 shadow-md">
            <div className="flex flex-col space-y-4">
              ...
              <a
                href="#"
                className="bg-indigo-600 text-white px-4 py-2 rounded-md flex items-center w-fit"
              >
                <Download size={16} className="mr-2" />
                Resume
              </a>
          ...
          <div className="md:flex md:items-center md:space-x-12">
            <div className="md:w-2/3 space-y-6">
              <h1 className="text-4xl md:text-5xl font-bold">
                Data Analyst with a passion for turning data into insights
              </h1>
              <p className="text-xl">
                Specialized in Excel, Python, SQL, and data visualization with
                3+ years of experience driving business decisions through data.
              </p>
              <div className="flex space-x-4">
                <a
                  href="#projects"
                  className="bg-white text-indigo-600 px-6 py-3 rounded-md font-medium flex items-center"
                >
                  View Projects
          ...
          <div className="md:flex md:space-x-12 items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <h3 className="text-2xl font-semibold mb-4">
                Hi, I'm [Giorgia Faedda]
              </h3>
              <p className="text-gray-600 mb-4">
                I'm a data analyst with expertise in transforming complex
                datasets into actionable insights. With a background in [your
                background, e.g., business analytics, statistics], I specialize
                in using data to solve business problems and drive strategic
                decisions.
              </p>
              <p className="text-gray-600 mb-4">
                My analytical journey began [brief career story]. I'm passionate
                about [specific areas of interest in data analysis] and
                continuously expanding my data science toolkit.
              </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
                  ...
                  <p className="text-gray-500">
                    e.g., Machine Learning, Data Ethics
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-12">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <div
                  key={skill}
                  className="bg-white px-4 py-3 rounded-md text-center shadow-sm"
                >
                  {skill}
                </div>
              ))}
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Explore my portfolio of data analysis projects showcasing
              Excel/Google Sheets, Python, SQL, and visualization expertise.
            </p>
          </div>
          ...
          <div className="mb-12">
            <div className="flex flex-wrap justify-center gap-4">
              <a
                href="#excel-projects"
                className="flex items-center bg-indigo-100 text-indigo-700 px-4 py-2 rounded-md"
              >
            ...
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <blockquote className="text-gray-600 italic mb-4">
                  "[Giorgia Faedda]'s analytical skills and attention to detail
                  transformed our data into actionable insights that directly
                  improved our business outcomes."
                </blockquote>
                <div className="flex items-center">
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="space-y-8">
            {[1, 2, 3].map((job) => (
              <div
                key={job}
                className="border-l-4 border-indigo-600 pl-6 ml-4 relative"
              >
                ...
                <ul className="text-gray-600 space-y-2">
                  <li>
                    • Led data analysis projects resulting in [specific
                    achievement]
                  </li>
                  <li>
                    • Created [type of report/dashboard] that [specific business
                    impact]
                  </li>
                  <li>
                    • Implemented [process/system] improving efficiency by
                    [quantifiable result]
                  </li>
                </ul>
              </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="mb-8">
                ...
                projects. Let's discuss how my data analysis skills can help
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p>giorgia.faedda@gfanalytics.se</p>
                  </div>
                </div>
                <div className="flex items-start">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <a href="#" className="text-xl font-bold">
                DataAnalyst<span className="text-indigo-400">Portfolio</span>
              </a>
